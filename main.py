...
num_epoch = 70
def main():
    train_images, test_images, train_labels, test_labels = dataset.train_test_data('../PetImages_resize')
    ...
    test_dataset = test_dataset.cache().shuffle(buffer_size=test_size).batch(test_size).make_one_shot_iterator().get_next()
